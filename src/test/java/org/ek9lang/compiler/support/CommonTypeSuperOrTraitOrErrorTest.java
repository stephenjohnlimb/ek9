...
class CommonTypeSuperOrTraitOrErrorTest extends AbstractSymbolTestBase {

  private final ErrorListener errorListener = new ErrorListener("test");
  private final CommonTypeSuperOrTraitOrError underTest = new CommonTypeSuperOrTraitOrError(errorListener);
