...
public class Ek9LanguageWords {
  ...
  private void setupKeyWords() {
    ...
    keywordMap.put("defines",
        new KeyWordInformation(
            "Define a module or construct block, https://www.ek9.io/structure.html",
            List.of(),
            TokenResult::previousTokensIndentsOrFirst
        )
    );
    ...
    keywordMap.put("by",
        new KeyWordInformation(
            "Generic/Type constraint. For loop incrementer. Trait delegation, Pipeline",
            List.of("by"),
            TokenResult::previousTokensIndentsOrFirst
        )
    );
  ...
  private void populateConstructs(Map<String, KeyWordInformation> keywordMap) {
    ...
    keywordMap.put("package",
        new KeyWordInformation(
            "Package build/publishing control, https://www.ek9.io/packaging.html",
            List.of("package\n"
            ),
            TokenResult::previousTokenIsDefines
        )
  ...
  private void populateModifiers(Map<String, KeyWordInformation> keywordMap) {
    ...
    keywordMap.put("abstract",
        new KeyWordInformation(
            "Non concrete functions/components/records/classes/methods/operators",
            List.of("abstract"),
            search -> !search.previousTokensIndentsOrFirst() && !search.previousTokenIsPipe()
        )
    );
  ...
  private void populateMathematicsOperators(Map<String, KeyWordInformation> keywordMap) {
    keywordMap.put("+",
        new KeyWordInformation(
            "Mathematical addition, https://www.ek9.io/operators.html#mathematical",
            List.of(),
            search -> !search.previousTokensIndentsOrFirst() && !search.previousTokenIsPipe()
        )
    );
    keywordMap.put("-",
        new KeyWordInformation(
            "Mathematical subtraction, https://www.ek9.io/operators.html#mathematical",
            List.of(),
            search -> !search.previousTokensIndentsOrFirst() && !search.previousTokenIsPipe()
        )
    );
    keywordMap.put("*",
        new KeyWordInformation(
            "Mathematical multiplication, https://www.ek9.io/operators.html#mathematical",
            List.of(),
            search -> !search.previousTokensIndentsOrFirst() && !search.previousTokenIsPipe()
        )
    );
    keywordMap.put("/",
        new KeyWordInformation(
            "Mathematical division, https://www.ek9.io/operators.html#mathematical",
            List.of(),
            search -> !search.previousTokensIndentsOrFirst() && !search.previousTokenIsPipe()
        )
    );
    ...
    keywordMap.put("++",
        new KeyWordInformation(
            "Mathematical increment, https://www.ek9.io/operators.html#mathematical",
            List.of(),
            search -> !search.previousTokensIndentsOrFirst() && !search.previousTokenIsPipe()
        )
    );
    keywordMap.put("--",
        new KeyWordInformation(
            "Mathematical decrement, https://www.ek9.io/operators.html#mathematical",
            List.of(),
            search -> !search.previousTokensIndentsOrFirst() && !search.previousTokenIsPipe()
        )
    );
    ...
    keywordMap.put("mod",
        new KeyWordInformation(
            "Mathematical modulus, https://www.ek9.io/operators.html#mathematical",
            List.of(),
            search -> !search.previousTokensIndentsOrFirst() && !search.previousTokenIsPipe()
        )
    );
    ...
    keywordMap.put("sqrt",
        new KeyWordInformation(
            "mathematical Square Root, https://www.ek9.io/operators.html#mathematical",
            List.of(),
            search -> !search.previousTokensIndentsOrFirst() && !search.previousTokenIsPipe()
        )
    );
  ...
  private void populateEqualityOperators(Map<String, KeyWordInformation> keywordMap) {
    ...
    keywordMap.put("<?",
        new KeyWordInformation(
            "Null safe less than, https://www.ek9.io/operators.html#assignment_coalescing",
            List.of(),
            search -> !search.previousTokensIndentsOrFirst() && !search.previousTokenIsPipe()
        )
    );
    keywordMap.put("<=",
        new KeyWordInformation(
            "Less than or equal to, https://www.ek9.io/operators.html#comparison",
            List.of(),
            search -> !search.previousTokensIndentsOrFirst() && !search.previousTokenIsPipe()
        )
    );
  ...
  private void populateAssignmentTypeOperators(Map<String, KeyWordInformation> keywordMap) {
    ...
    keywordMap.put("?:",
        new KeyWordInformation(
            "Null is set coalescing (Elvis), https://www.ek9.io/operators.html#ternary",
            List.of(),
            search -> !search.previousTokensIndentsOrFirst() && !search.previousTokenIsPipe()
        )
    );
    ...
    keywordMap.put("::",
        new KeyWordInformation(
            "References construct, https://www.ek9.io/basics.html#references_example",
            List.of(),
            search -> !search.previousTokensIndentsOrFirst() && !search.previousTokenIsPipe()
        )
    );
  ...
  private void populateFlowControl(Map<String, KeyWordInformation> keywordMap) {
    ...
    keywordMap.put("switch",
        new KeyWordInformation(
            "Conditional switch/given, https://www.ek9.io/flowControl.html#switch",
            List.of(),
            search -> search.previousTokensIndentsOrFirst() || search.previousTokenIsAssignment()
        )
    );
    ...
    keywordMap.put("else",
        new KeyWordInformation(
            "Conditional else, https://www.ek9.io/flowControl.html#if_elseif_else",
            List.of("else"),
            TokenResult::previousTokensIndentsOrFirst
        )
    );
