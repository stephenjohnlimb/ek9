...
final class AsmStructureCreator {
  ...
  void processMethodOnClass(final Operation operation) {
    ...
    methodVisitor.visitTypeInsn(NEW, "org/ek9/lang/Stdout");
    methodVisitor.visitInsn(DUP);
    methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/ek9/lang/Stdout", INIT, "()V", false);
    methodVisitor.visitVarInsn(ASTORE, 1);
    Label label1 = new Label();
    methodVisitor.visitLabel(label1);
    ...
    methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/ek9/lang/Stdout", "println", "(Lorg/ek9/lang/String;)V", false);
    Label label2 = new Label();
    methodVisitor.visitLabel(label2);
