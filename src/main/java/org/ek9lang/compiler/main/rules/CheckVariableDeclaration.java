 ...
 */
public class CheckVariableDeclaration implements Consumer<EK9Parser.VariableDeclarationContext> {
   ...
   */
  public CheckVariableDeclaration(final SymbolAndScopeManagement symbolAndScopeManagement,
