 ...
 */
final class RangeOrError extends TypedSymbolAccess implements Consumer<EK9Parser.RangeContext> {
   ...
   */
  RangeOrError(final SymbolsAndScopes symbolsAndScopes,
  ...
  public void accept(final EK9Parser.RangeContext ctx) {
    ...
    if (fromExpr != null && toExpr != null) {
      final var commonType = commonTypeSuperOrTraitOrError.apply(startToken, List.of(fromExpr, toExpr));
