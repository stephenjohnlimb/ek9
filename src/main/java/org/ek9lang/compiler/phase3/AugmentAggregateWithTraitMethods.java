 ...
 * What this means is the any abstract methods in the trait (and its supers not implemented) must
 ...
 */
public class AugmentAggregateWithTraitMethods extends TypedSymbolAccess
  ...
  protected AugmentAggregateWithTraitMethods(
