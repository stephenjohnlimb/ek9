 ...
 */
abstract class OperatorTest extends TypedSymbolAccess implements BiPredicate<IToken, ISymbol> {
  ...
  protected OperatorTest(final SymbolsAndScopes symbolsAndScopes,
  ...
  protected boolean isOperatorPresent(final CheckOperatorData data) {
    ...
    final var locatedIsSet = requiredOperatorPresentOrError.apply(data);
