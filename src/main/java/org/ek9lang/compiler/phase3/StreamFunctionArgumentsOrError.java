 ...
 */
final class StreamFunctionArgumentsOrError extends TypedSymbolAccess implements Consumer<StreamFunctionCheckData> {
  private final SymbolTypeExtractor symbolTypeExtractor = new SymbolTypeExtractor();

  StreamFunctionArgumentsOrError(final SymbolsAndScopes symbolsAndScopes,
