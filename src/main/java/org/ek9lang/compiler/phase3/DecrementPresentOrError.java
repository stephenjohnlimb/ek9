 ...
 */
class DecrementPresentOrError extends OperatorTest implements BiPredicate<IToken, ISymbol> {

  DecrementPresentOrError(final SymbolsAndScopes symbolsAndScopes,
