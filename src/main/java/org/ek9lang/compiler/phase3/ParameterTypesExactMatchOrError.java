 ...
 */
final class ParameterTypesExactMatchOrError extends TypedSymbolAccess implements Consumer<ParametersData> {
  ...
  ParameterTypesExactMatchOrError(final SymbolsAndScopes symbolsAndScopes,
  ...
  @Override
  public void accept(final ParametersData data) {
  ...
  private void emitErrorInFunctionSignature(final ParametersData data, final String additionalInformation) {
