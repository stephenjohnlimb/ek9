 ...
 */
public class ResolveThisSuperOrError extends RuleSupport implements Function<EK9Parser.CallContext, MethodSymbol> {
  ...
  protected ResolveThisSuperOrError(SymbolAndScopeManagement symbolAndScopeManagement,
