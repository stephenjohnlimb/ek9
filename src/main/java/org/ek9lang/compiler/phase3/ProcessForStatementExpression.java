...
final class ProcessForStatementExpression extends TypedSymbolAccess
  ...
  ProcessForStatementExpression(SymbolAndScopeManagement symbolAndScopeManagement,
  ...
  public void accept(final EK9Parser.ForStatementExpressionContext ctx) {
    ...
    var forExpression = (ForSymbol) symbolAndScopeManagement.getRecordedSymbol(ctx);
