...
public enum CommonValues {
  ...
  RESULT_OK_ACCESS_REQUIRES_SAFE_ACCESS("RESULT_OK_ACCESS_REQUIRES_SAFE_ACCESS"),
  RESULT_ERROR_ACCESS_REQUIRES_SAFE_ACCESS("RESULT_ERROR_ACCESS_REQUIRES_SAFE_ACCESS"),
  OPTIONAL_GET_ACCESS_REQUIRES_SAFE_ACCESS("OPTIONAL_GET_ACCESS_REQUIRES_SAFE_ACCESS"),
