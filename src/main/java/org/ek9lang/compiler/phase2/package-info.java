 ...
 * Again the {@link org.ek9lang.compiler.common.SymbolAndScopeManagement} class is used to manage the scopes.
 * </p>
 * <p>
 * The Symbols and scopes that were defined in phase1 are now lookup up using the
 * {@link org.ek9lang.compiler.common.SymbolAndScopeManagement} and in some cases augmented or in other cases checked.
 * </p>
 * <p>
