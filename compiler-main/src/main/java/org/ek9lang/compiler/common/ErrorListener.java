...
public class ErrorListener extends BaseErrorListener implements Serializable {
  ...
  public enum SemanticClassification {
    ...
    DEFAULT_ONLY_FOR_CONSTRUCTORS("'default' modifier is only valid for constructors, not regular methods"),
    ...
    SUPER_FOR_ANY_NOT_REQUIRED("'super' for implicit 'Any' base class is not required"),
