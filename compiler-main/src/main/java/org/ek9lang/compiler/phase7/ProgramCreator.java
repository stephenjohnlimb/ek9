 ...
 */
final class ProgramCreator implements Function<EK9Parser.MethodDeclarationContext, IRConstruct> {

  private final ParsedModule parsedModule;
  private final CompilerFlags compilerFlags;

  public ProgramCreator(final ParsedModule parsedModule, final CompilerFlags compilerFlags) {
  ...
  private void createOperation(final IRConstruct construct, final AggregateSymbol aggregateSymbol,
    ...
    optionalMethod.ifPresent(method -> {
      ...
      // Create IRGenerationContext for this program's executable code
      ...
      // Generate BasicBlock IR for the program
