 ...
 */
final class RecordCreator implements Function<EK9Parser.RecordDeclarationContext, IRConstruct> {

  private final ParsedModule parsedModule;
  private final CompilerFlags compilerFlags;

  public RecordCreator(final ParsedModule parsedModule, final CompilerFlags compilerFlags) {
