...
public enum CommonValues {
  ...
  DO("DO"),
  WHILE("WHILE"),
  FOR_ITERATION_PATTERN("FOR_ITERATION_PATTERN"),
  ...
  HAS_EXPLICIT_CONSTRUCTION("HAS_EXPLICIT_CONSTRUCTION"),
  EXPLICIT_SUPER_CALL("EXPLICIT_SUPER_CALL"),
  EXPLICIT_THIS_CALL("EXPLICIT_THIS_CALL"),
