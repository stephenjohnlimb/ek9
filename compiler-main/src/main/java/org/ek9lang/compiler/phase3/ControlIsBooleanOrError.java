 ...
 */
final class ControlIsBooleanOrError extends TypedSymbolAccess implements Consumer<EK9Parser.ExpressionContext> {
  ControlIsBooleanOrError(final SymbolsAndScopes symbolsAndScopes,
