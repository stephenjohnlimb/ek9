 ...
 */
final class DynamicFunctionBodyPresentOrError extends TypedSymbolAccess
   ...
   */
  DynamicFunctionBodyPresentOrError(final SymbolsAndScopes symbolsAndScopes,
  ...
  public void accept(final EK9Parser.DynamicFunctionDeclarationContext ctx) {
    ...
    symbol.getSuperFunction().ifPresent(superFunction -> {
      ...
      pureModifierOrError.accept(new PureCheckData("", superFunction, symbol));
    });
