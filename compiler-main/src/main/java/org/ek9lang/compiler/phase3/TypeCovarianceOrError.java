 ...
 */
final class TypeCovarianceOrError extends TypedSymbolAccess implements Consumer<CovarianceData> {
  TypeCovarianceOrError(final SymbolsAndScopes symbolsAndScopes,
  ...
  @Override
  public void accept(final CovarianceData data) {
  ...
  private void emitCovarianceMismatch(final CovarianceData data, final String additionalInformation) {
