 ...
 */
final class ExceptionTypeOrError extends TypedSymbolAccess implements BiConsumer<IToken, ISymbol> {
  ExceptionTypeOrError(final SymbolsAndScopes symbolsAndScopes,
