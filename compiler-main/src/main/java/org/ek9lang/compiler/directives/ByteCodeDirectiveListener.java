  ...
  protected void symbolMatch(final CompilationEvent compilationEvent,
    ...
    if (!lineComparator.test(resolutionDirective.getAdditionalName(), normalizedBytecode)) {
      ...
      synchronized (OUTPUT_LOCK) {
        System.err.println("===BYTECODE_UPDATE_START===");
        ...
        System.err.println("---BYTECODE_CONTENT_START---");
        System.err.print(normalizedBytecode);
        System.err.println("---BYTECODE_CONTENT_END---");
        System.err.println("===BYTECODE_UPDATE_END===");
        System.err.flush();
      }
