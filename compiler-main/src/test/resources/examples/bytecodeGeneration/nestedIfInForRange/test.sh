#!/usr/bin/env bash
#
# E2E test for nestedIfInForRange
...
# Project-relative paths (8 levels up to project root from nestedIfInForRange/)
...
$EK9_BINARY nestedIfInForRange.ek9 > actual_output.txt 2>&1
