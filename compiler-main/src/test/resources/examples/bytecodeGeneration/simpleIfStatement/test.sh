#!/usr/bin/env bash
#
# E2E test for simpleIfStatement
...
# Project-relative paths (8 levels up to project root from simpleIfStatement/)
...
$EK9_BINARY simpleIfStatement.ek9 > actual_output.txt 2>&1
