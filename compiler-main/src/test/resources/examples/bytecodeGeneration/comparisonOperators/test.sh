#!/usr/bin/env bash
#
# E2E test for comparisonOperators
...
# Project-relative paths (8 levels up to project root from comparisonOperators/)
...
$EK9_BINARY comparisonOperators.ek9 > actual_output.txt 2>&1
