#!/usr/bin/env bash
#
# E2E test for lessThanCoalescingOperator
...
# Project-relative paths (8 levels up to project root from lessThanCoalescingOperator/)
...
$EK9_BINARY lessThanCoalescingOperator.ek9 > actual_output.txt 2>&1
