#!/usr/bin/env bash
#
# E2E test for simpleForRangeLoop
...
# Project-relative paths (8 levels up to project root from simpleForRangeLoop/)
...
$EK9_BINARY simpleForRangeLoop.ek9 > actual_output.txt 2>&1
