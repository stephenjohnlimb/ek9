#!/usr/bin/env bash
#
# E2E test for tryWithSingleResource
# Validates automatic resource cleanup with try-with-resources
#

set -e
cd "$(dirname "$0")"

# Project-relative paths (8 levels up to project root from tryWithSingleResource/)
...
$EK9_BINARY tryWithSingleResource.ek9 > actual_output.txt 2>&1
