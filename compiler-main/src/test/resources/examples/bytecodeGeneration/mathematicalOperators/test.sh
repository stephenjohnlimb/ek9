#!/usr/bin/env bash
#
# E2E test for mathematicalOperators
...
# Project-relative paths (8 levels up to project root from mathematicalOperators/)
...
$EK9_BINARY mathematicalOperators.ek9 > actual_output.txt 2>&1
