#!/usr/bin/env bash
#
# E2E test for tryWithMultipleResourcesAndFinally
# Validates automatic resource cleanup with multiple resources AND explicit finally block
#

set -e
cd "$(dirname "$0")"

# Project-relative paths (8 levels up to project root from tryWithMultipleResourcesAndFinally/)
...
$EK9_BINARY tryWithMultipleResourcesAndFinally.ek9 > actual_output.txt 2>&1
