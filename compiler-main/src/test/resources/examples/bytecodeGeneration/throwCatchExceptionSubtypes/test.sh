#!/usr/bin/env bash
#
# E2E test for throwCatchExceptionSubtypes
...
# Project-relative paths (8 levels up to project root from throwCatchExceptionSubtypes/)
...
$EK9_BINARY throwCatchExceptionSubtypes.ek9 > actual_output.txt 2>&1
