#!/usr/bin/env bash
#
# E2E test for mixedCoalescingOperators
...
# Project-relative paths (8 levels up to project root from mixedCoalescingOperators/)
...
$EK9_BINARY mixedCoalescingOperators.ek9 > actual_output.txt 2>&1
