#!/usr/bin/env bash
#
# E2E test for tryWithMultipleResources
# Validates automatic cleanup of multiple resources in try-with-resources
#

set -e
cd "$(dirname "$0")"

# Project-relative paths (8 levels up to project root from tryWithMultipleResources/)
...
$EK9_BINARY tryWithMultipleResources.ek9 > actual_output.txt 2>&1
