#!/usr/bin/env bash
#
# E2E test for elvisCoalescingOperator
...
# Project-relative paths (8 levels up to project root from elvisCoalescingOperator/)
...
$EK9_BINARY elvisCoalescingOperator.ek9 > actual_output.txt 2>&1
