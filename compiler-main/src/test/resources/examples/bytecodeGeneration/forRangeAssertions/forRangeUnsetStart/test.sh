#!/usr/bin/env bash
#
# E2E test for forRangeUnsetStart
...
# Project-relative paths (9 levels up from forRangeAssertions/forRangeUnsetStart/)
...
$EK9_BINARY forRangeUnsetStart.ek9 > actual_error.txt 2>&1
