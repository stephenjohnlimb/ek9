...
# Project-relative paths (9 levels up from forRangeAssertions/forRangeUnsetBy/)
...
$EK9_BINARY forRangeUnsetBy.ek9 > actual_error.txt 2>&1
...
echo "PASS: forRangeUnsetBy (assertion verified)"
