#!/usr/bin/env bash
#
# E2E test for multipleNullCoalescingOperator
...
# Project-relative paths (8 levels up to project root from multipleNullCoalescingOperator/)
...
$EK9_BINARY multipleNullCoalescingOperator.ek9 > actual_output.txt 2>&1
