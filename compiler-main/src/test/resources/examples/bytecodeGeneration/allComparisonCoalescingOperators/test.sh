#!/usr/bin/env bash
#
# E2E test for allComparisonCoalescingOperators
...
# Project-relative paths (8 levels up to project root from allComparisonCoalescingOperators/)
...
$EK9_BINARY allComparisonCoalescingOperators.ek9 > actual_output.txt 2>&1
