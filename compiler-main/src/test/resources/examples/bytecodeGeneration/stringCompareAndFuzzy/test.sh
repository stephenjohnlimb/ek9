#!/usr/bin/env bash
#
# E2E test for stringCompareAndFuzzy
...
# Project-relative paths (8 levels up to project root from stringCompareAndFuzzy/)
...
$EK9_BINARY stringCompareAndFuzzy.ek9 > actual_output.txt 2>&1
