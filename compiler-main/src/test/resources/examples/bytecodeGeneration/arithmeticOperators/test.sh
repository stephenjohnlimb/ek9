#!/usr/bin/env bash
#
# E2E test for arithmeticOperators
...
# Project-relative paths (8 levels up to project root from arithmeticOperators/)
...
$EK9_BINARY arithmeticOperators.ek9 > actual_output.txt 2>&1
