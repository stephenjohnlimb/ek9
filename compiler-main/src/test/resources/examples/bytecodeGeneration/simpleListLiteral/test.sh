#!/usr/bin/env bash
#
# E2E test for simpleListLiteral
...
# Project-relative paths (8 levels up to project root from simpleListLiteral/)
...
$EK9_BINARY simpleListLiteral.ek9 > actual_output.txt 2>&1
