#!/usr/bin/env bash
#
# E2E test for conversionOperators
...
# Project-relative paths (8 levels up to project root from conversionOperators/)
...
$EK9_BINARY conversionOperators.ek9 > actual_output.txt 2>&1
