#!/usr/bin/env bash
#
# E2E test for simpleDoWhileLoop
...
# Project-relative paths (8 levels up to project root from simpleDoWhileLoop/)
...
$EK9_BINARY simpleDoWhileLoop.ek9 > actual_output.txt 2>&1
