...
export EK9_HOME
$EK9_BINARY -C *.ek9
$EK9_BINARY *.ek9 1 > actual_case_1.txt 2>&1
if ! diff -u expected_case_1.txt actual_case_1.txt; then echo "FAIL: Case 1"; exit 1; fi
$EK9_BINARY *.ek9 0 > actual_case_0.txt 2>&1
