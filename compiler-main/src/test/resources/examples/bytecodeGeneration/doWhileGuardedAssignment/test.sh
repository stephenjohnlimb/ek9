...
export EK9_HOME
$EK9_BINARY -C *.ek9
$EK9_BINARY doWhileGuardedAssignment.ek9 5 > actual_case_5.txt 2>&1
if ! diff -u expected_case_5.txt actual_case_5.txt; then echo "FAIL: Case 5"; exit 1; fi
$EK9_BINARY doWhileGuardedAssignment.ek9 0 > actual_case_0.txt 2>&1
if ! diff -u expected_case_0.txt actual_case_0.txt; then echo "FAIL: Case 0"; exit 1; fi
echo "PASS: doWhileGuardedAssignment"
