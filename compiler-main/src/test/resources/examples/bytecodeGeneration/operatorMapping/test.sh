#!/usr/bin/env bash
#
# E2E test for operatorMapping
# Validates EK9 operator to JVM method name mapping
#

set -e
cd "$(dirname "$0")"

# Project-relative paths (8 levels up to project root from operatorMapping/)
...
$EK9_BINARY operatorMapping.ek9 > actual_output.txt 2>&1
