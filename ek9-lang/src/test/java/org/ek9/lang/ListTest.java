...
class ListTest extends Common {
  ...
  class ElementAccess {
    ...
    void testGetMethod() {
      ...
      // Valid indices
      assertEquals(str1, testList.get(INT_0));
      assertEquals(str2, testList.get(INT_1));
      assertEquals(str3, testList.get(INT_2));

      // Invalid index - positive index out of bounds throws EK9 Exception
      assertThrows(Exception.class, () -> testList.get(INT_3));
      // Negative index throws IndexOutOfBoundsException from underlying ArrayList  
      assertThrows(Exception.class, () -> testList.get(INT_MINUS_1));
  ...
  class UtilityOperations {
    ...
    void testReverse() {
      ...
      assertEquals(str2, reversedList.get(INT_1));
  ...
  class ImmutableArithmeticOperations {
    ...
    void testImmutableAddition() {
      ...
      assertEquals(str1, addedList.get(INT_0));
      assertEquals(str2, addedList.get(INT_1));
      assertEquals(str3, addedList.get(INT_2));
    ...
    void testImmutableSubtraction() {
      ...
      assertEquals(str3, subtractedElement.get(INT_1));
  ...
  class MutableArithmeticOperations {
    ...
    void testMutableAddition() {
      ...
      assertEquals(str1, list1.get(INT_0));
      assertEquals(str2, list1.get(INT_1));
      assertEquals(str3, list1.get(INT_2));
  ...
  class EdgeCases {
    ...
    void testEdgeCases() {
      ...
      assertEquals(INT_0, largeList.first());
